...
// const url={
//   background :url(https://source.unsplash.com/650x700/?nature,water),
// }
      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-12 col-md-12 col-lg-8 offset-lg-2">
            <h1 className="pagetitle__heading">Bachelor of Technology </h1>
...
<div className="container">
  <div className='row'>
  <p><h5>Top Engineering Colleges in India 2021-</h5><span> Science stream students who are looking for the best engineering colleges in India must know what and how to choose the right colleges. Several criteria are linked with the searching of top Btech/BE colleges in India including NIRF ranking, infrastructure, placements and more. While searching for the best engineering college, there will be a lot of confusion and chaos.  Hence, here we have provided the list of top engineering colleges of India based on different criteria-</span></p>
  </div>
</div>
              ...
              <div className="widget widget-categories">
                <div className="widget-content">
                  <ul className="list-unstyled">
                    <li>
                      <a href="#" className="active"><span>Bachelor of Technology </span><i
                          className="icon-arrow-right"></i></a>
                    </li>
                    <li>
                      <a href="#"><span>Politechnic</span><i className="icon-arrow-right"></i></a>
                    </li>
                    <li>
                      <a href="#"><span>BCA</span><i className="icon-arrow-right"></i></a>
                    </li>
                    <li>
                      <a href="#"><span>ITI</span><i className="icon-arrow-right"></i></a>
                    </li>
                    {/* <li>
            ...
            <div className="row">
              <div className="col-sm-12 col-md-12 col-lg-12">
                <div className="abttop">
                  <h3 className="smallheading">Top 31 Btech College in India</h3>
