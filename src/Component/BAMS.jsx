      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-12 col-md-12 col-lg-8 offset-lg-2">
            <h1 className="pagetitle__heading">BAMS</h1>
              ...
              <div className="widget widget-categories">
                <div className="widget-content">
                  <ul className="list-unstyled">
                    ...
                    <li>
                      <a href="#"><span>MBBS</span><i className="icon-arrow-right"></i></a>
                    </li>
                    <li>
                      <a href="#"><span>BDS</span><i className="icon-arrow-right"></i></a>
                    </li>
                    <li>
                      <a href="#" className="active"><span>BAMS </span><i
            ...
            <div className="row">
              <div className="col-sm-12 col-md-12 col-lg-12">
                <div className="abttop">
                  <h3 className="smallheading">Top 31 BAMS College in India</h3>
