      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-12 col-md-12 col-lg-8 offset-lg-2">
            <h1 className="pagetitle__heading">Politechnic</h1>
              ...
              <div className="widget widget-categories">
                <div className="widget-content">
                  <ul className="list-unstyled">
                    <li>
                      <a href="#"><span>Bachelor of Technology</span><i className="icon-arrow-right"></i></a>
                    </li>
                    <li>
                      <a href="#" className="active"><span>Politechnic</span><i
            ...
            <div className="row">
              <div className="col-sm-12 col-md-12 col-lg-12">
                <div className="abttop">
                  <h3 className="smallheading">Top 31 Politechnic College in India</h3>
