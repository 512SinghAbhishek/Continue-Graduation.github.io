                                ...
                                <div className="col-sm-12 col-md-12 col-lg-12 col-xl-8">
                                    <div className="slide__content">
                                        ...
                                        <h2 className="slide__title">
                                            Manufacturing A High Quality Products</h2>
                                        <p className="slide__desc">Develop our corporate strengths we have established a corporate mandate to
                    ...
                    <div className="tl-item">
                        ...
                        <div className="tl-year">
                            <a href="WeldingConsumables.html">
                                <p className=" heading--sanSerif text-white ">Welding Consumables</p>
                            </a>
                        </div>
                    ...
                    <div className="tl-item">
                        ...
                        <div className="tl-year">
                            <a href="nonwelding.html">
                                <p className="f2 heading--sanSerif text-white">Non Welding Application Wires</p>
                            </a>
                    ...
                    <div className="tl-item">
                        ...
                        <div className="tl-year">
                            <a href="rollinguide.html">
                                <p className="f2 heading--sanSerif text-white">Rolling Guide</p>
                            </a>
                        </div>
